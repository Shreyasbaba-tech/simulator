...
<td><button value="Upload Excell" class="topopup">Upload Excel</button><br><button value="Save As New" onclick="goToBulkResponsePage();">Save Bulk Response</button></td></tr>
</table>
