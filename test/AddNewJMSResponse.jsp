...
function makeRequest3(){
	...
	var xmlHttpRequest = getXMLHttpRequest();
	  ...
	  <%	  String appId=(String)request.getSession().getAttribute("appId");
			  String srvcName=(String)request.getSession().getAttribute("srvcName");
			  String operName=(String)request.getSession().getAttribute("operName");
			  String respIdentifierKey=(String)request.getSession().getAttribute("respIdentifierKey");
	 %>
	 system='<%=srvcName%>';
	 subSys='<%=operName%>';
	 appId='<%=appId%>';
...
<tr>
<td>App ID:</td>
<td><b><s:property value="appId" /></b></td>
</tr>
<tr>
<td>Service Name</td>
<td><b><s:property value="srvcName"/></b></td>
</tr>
<tr>
<td>Operation Name:</td>
<td><b><s:property value="operName"/></b></td>
</tr>
