...
<%String searchTags = (String)request.getAttribute("searchTags"); %>
 ...
 String subSys=info.getSubSystem();
...
function callAddResponseAction() {
...
<body onload="init()">
<s:form action="SaveAsNewResponseAction.action" id="addResponseForm" name="addResponseForm" method="post" enctype="multipart/form-data">
<table align="center">
<h3 align="center"><b>
ADD/EDIT RESPONSE
</b></h3>
...
<tr>
<td>App ID:</td>
<td><b><%=info.getAppId()%></b></td>
</tr>
<tr>
<td>Service Name</td>
<td><b><%=info.getSystem()%></b></td>
</tr>
<tr>
<td>Operation Name:</td>
<td><b><%=info.getSubSystem()%></b></td>
</tr>
...
<tr><td><s:textarea label="Response file Contents" id="content" key="content" rows="6" cols="35"/></td></tr>
<tr><td><s:hidden id="rowCount" name="rowCount" value="0"></s:hidden></td></tr>
<tr><td><button  onclick="callAddResponseAction();">Add Response</button></td></tr>
</table>
